				...
				<tr>
					...
					<td><p>
						...
						<ul>
							...
							<li><a href="CIMTcookieRecipe.php">Cookie Recipe</a></li>
							<li><a href="CIMTbreadRecipe.php">Bread Recipe</a></li>
							<li><a href="CIMTgarlicChickenRecipe.php">Garlic Chicken</a></li>
							<li><a href="CIMTcakeRecipe.php">Cake</a></li>
							<li><a href="CIMTgreenSaladRecipe.php">Green Salad</a></li>
...
echo "Select A recipe to see if you have the necessary ingredients.

If the recipe can't be made, it will tell you what ingredients you need.<br><br>";
...
$recipeQuery = "Select ingredientName,  amount , quantity , unit, quantityOfUnitsPerCup, caloriesPerUnit, unitName
                    from cakeRecipe cr, ingredients i
